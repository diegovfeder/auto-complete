...
/**
 * Represents a static list of country data, each item being a `Country` type object.
 * These objects contain detailed information about various countries including their
 * respective flag icon, name, abbreviation, and country code.
 * 
 * @type {Country[]}
 */
const countries: Country[] = [
  { icon: "🇦🇫", name: "Afghanistan", abbr: "AF", code: "93" },
  { icon: "🇦🇽", name: "Åland Islands", abbr: "AX", code: "358" },
  ...
  { icon: "🇦🇺", name: "Australia", abbr: "AU", code: "61" },
  ...
  { icon: "🇨🇦", name: "Canada", abbr: "CA", code: "1" },
  ...
  { icon: "🇨🇬", name: "Congo, Republic of the", abbr: "CG", code: "243" },
  {
    icon: "🇨🇩",
  ...
  { icon: "🇫🇷", name: "France", abbr: "FR", code: "33" },
  ...
  { icon: "🇩🇪", name: "Germany", abbr: "DE", code: "49" },
  ...
  { icon: "🇯🇵", name: "Japan", abbr: "JP", code: "81" },
  ...
  { icon: "🇺🇸", name: "United States", abbr: "US", code: "1" },
